(function($) {
  ...
  $(document).ready(function() {
    ...
    init_portfolio_details1();
    init_portfolio_details2()
    init_portfolio_details3()
    init_portfolio_details4()
  });
  ...
  function init_portfolio_details1() { 
    $(".show-portfolio1").on("click", function() {
      var $this = $(this);
      var $el = $("#show-portofolio-details");
      var $wrap = $("#portofolio-details");
      $wrap.addClass('uk-animation-toggle');
      ...
      //show loading first
      $wrap.html(
        '<div class="uk-grid-collapse  uk-child-width-1-1 uk-animation-scale-down" data-uk-grid>'+
'    <div class="uk-background-cover uk-width-2-5@m  yb-full-height " data-uk-img data-src="src/img/work/01.jpg" >  </div>'+
'    <div class="uk-padding-large  uk-width-expand@m yb-full-height yb-full-height-fixed yb-work-content" >'+
'      <p><span class="yb-label uk-label uk-border-rounded">Completed</span> </p>'+
'      <h1 class="yb-section-title">OctoBot</h1> '+
'      <h5>Discord Bot written in Eris.js</h5> '+
'      <hr> '+
'      <p>A powerful utilitarian and mod bot for Discord!</p>'+
'      <div data-uk-grid class="uk-child-width-1-2 uk-grid-medium">'+
'        <div>'+
'          <img src="src/img/work/03.jpg" class="uk-border-rounded" alt="">'+
'        </div>'+
'        <div>'+
'          <img src="src/img/work/02.jpg" class="uk-border-rounded" alt="">'+
'        </div>'+
'      </div>'+
...
'        stitching in a copper tone, the R8 V10 Decennium edition pays tribute to its V10 heritage.</p> '+
'      <h4 class="yb-section-title uk-heading-line"><span>Client</span></h4>'+
...
'  </div>'
  ...
  function init_portfolio_details2() { 
    $(".show-portfolio1").on("click", function() {
      var $this = $(this);
      var $el = $("#show-portofolio-details");
      var $wrap = $("#portofolio-details");
...
'  </div>'
  ...
  function init_portfolio_details3() { 
    $(".show-portfolio1").on("click", function() {
      var $this = $(this);
      var $el = $("#show-portofolio-details");
      var $wrap = $("#portofolio-details");
...
'  </div>'
  ...
  function init_portfolio_details4() { 
    $(".show-portfolio1").on("click", function() {
      var $this = $(this);
      var $el = $("#show-portofolio-details");
      var $wrap = $("#portofolio-details");
